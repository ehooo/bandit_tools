...
@test.checks('Call')
@test.test_id('DJ-SQLi-EXTRA')
def django_extra_used(context):
    """**DJ-SQLi-EXTRA: Potential SQL injection on extra function**
...
@test.checks('Call')
@test.test_id('DJ-SQLi-RAW')
def django_rawsql_used(context):
    """**DJ-SQLi-RAW: Potential SQL injection on RawSQL function**
